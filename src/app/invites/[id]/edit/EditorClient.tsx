            ...
            <div className="mt-3 grid gap-3">
              ...
              <label className="grid gap-1">
                ...
                <p className="text-[10px] leading-snug text-white/35">
                  На странице гостя контент блоков появляется после паузы: до этого видны только фон и рамка карточки, без
                  индикатора загрузки — удобно совместить с фоновым видео. В превью слева блоки всегда видны сразу.
                </p>
              </label>
